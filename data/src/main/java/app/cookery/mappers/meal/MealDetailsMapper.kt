...
@Singleton
class MealDetailsMapper @Inject constructor() : Mapper<MealDetailsEntity?, MealDetails?> {

    override suspend fun map(from: MealDetailsEntity?) = from?.let {
        MealDetails(
            mealId = it.mealId,
            ...
            mealMeasure18 = it.mealMeasure18,
